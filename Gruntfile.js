...
module.exports = function (grunt) {
    ;(function(){
        ...
        var path1 = './node_modules/grunt-modernizr/lib/cache/modernizr.load.1.5.4.js';
        var contents1 = grunt.file.read(path1);
        grunt.file.write(path1,contents1);
    })();
    ...
    grunt.initConfig({
        ...
        bower: {
            all: {
                rjsConfig: '<%= config.app %>/scripts/app.js',
                options: {
        ...
        /*bowerInstall: { //disabled when using requirejs
            app: {
        ...
        copy: {
            dist: {
                files: [{
                    ...
                    expand: true,
                    cwd: '<%= config.app %>',
                    src:['bower_components/**/fonts/*.*', 'fonts/*.*'],
                    flatten:true,
        ...
        less: {
            development: {
                ...
                files: {
                    ...
                    '<%= config.app %>/styles/myratch.css': '<%= config.app %>/styles/myratchet.less'
                }
            },
            production: {
                options: {
